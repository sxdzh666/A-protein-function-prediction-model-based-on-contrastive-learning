...
@ck.command()
@ck.option(
    '--go-file', '-gf', default='data_cafa3/go.obo',
    help='Gene Ontology file in OBO Format')
@ck.option(
    '--train-annotations-file', '-traf', default='data_cafa3/CAFA3_training_data/uniprot_sprot_exp.txt',
    help='CAFA training annotations fasta')
@ck.option(
    '--train-sequences-file', '-trsf', default='data_cafa3/CAFA3_training_data/uniprot_sprot_exp.fasta',
    help='CAFA training sequences fasta')
@ck.option(
    '--test-sequences-file', '-tssf', default='data_cafa3/CAFA3_targets/targets_all.fasta',
    help='CAFA training annotations fasta')
@ck.option(
    '--test-annotations-file', '-tsaf', default='data_cafa3/benchmark20171115/groundtruth/leafonly_all.txt',
    help='CAFA training annotations fasta')
@ck.option(
    '--out-terms-file', '-otf', default='data_cafa3/terms.pkl',
    help='Result file with a list of terms for prediction task')
@ck.option(
    '--train-data-file', '-trdf', default='data_cafa3/train_data.pkl',
    help='Result file with a list of terms for prediction task')
@ck.option(
    '--test-data-file', '-tsdf', default='data_cafa3/test_data.pkl',
    help='Result file with a list of terms for prediction task')
@ck.option(
    '--min-count', '-mc', default=50,
    help='Minimum number of annotated proteins')
def main(go_file, train_annotations_file, train_sequences_file,
